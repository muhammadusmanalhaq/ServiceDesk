...
- Local PostgreSQL instance or [Neon](https://neon.tech/) account
...
dotnet user-secrets set "ConnectionStrings:System" "Host=...;Database=...;Username=...;Password=..."
