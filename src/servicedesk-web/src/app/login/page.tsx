    ...
    <div className="min-h-screen flex items-center justify-center w-full bg-zinc-100 dark:bg-zinc-950 p-4 transition-colors">
      <div className="w-full max-w-md p-8 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 shadow-xl rounded-2xl transition-colors">
        ...
        <div className="flex flex-col items-center justify-center space-y-3 mb-8">
          <div className="p-3 bg-indigo-100 dark:bg-indigo-500/20 rounded-full border border-indigo-200 dark:border-indigo-500/30">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              required
              className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 rounded-lg px-4 py-2.5 text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
            />
          </div>
          ...
          <div className="pt-4">
            <button 
              ...
              className="w-full flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg h-11 text-base font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed" 
            >
              {isSubmitting ? (
